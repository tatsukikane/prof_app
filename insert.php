...
//３．データ登録SQL作成
$sql = "INSERT INTO sov_map_table(name, birthplace, sov, sov2, career, main_text, insta, twitter, indate, Facebook, userid) 
VALUES(:name, :birthplace, :sov, :sov2, :career, :main_text, :insta, :twitter, sysdate(), :Facebook, :userid);";
